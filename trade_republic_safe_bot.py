...
- Envoie seulement les meilleurs signaux
- Mode SAFE : sélection stricte, pas d'auto-trading
...
def thresholds_for_asset(asset_type: str) -> dict:
    if asset_type == "CRYPTO":
        return {
            ...
            "distance_min": -6.0,
            "distance_max": 4.0,
            "too_hot_distance": 5.5,
            "too_hot_perf_20d": 18.0,
        }
    ...
    return {
        ...
        "distance_min": -4.0,
        "distance_max": 2.5,
        "too_hot_distance": 3.5,
        "too_hot_perf_20d": 10.0,
    }
...
def analyze_ticker(ticker: str, asset_type: str) -> dict | None:
    ...
    # Score plus variable et plus punitif
    score = 50
    ...
    # Prix sous EMA50 = mauvais signal en safe
    if last_close < last_ema50:
        score -= 15

    # Prix sous EMA20 = petite pénalité supplémentaire
    if last_close < last_ema20:
        score -= 8

    # Trop étiré = forte pénalité
    if too_hot:
        score -= 16
...
🧠 Confiance : <b>{item['confidence']}/100</b>
