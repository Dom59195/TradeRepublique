"""
Bot Scanner SAFE PRO — Version équilibrée
=========================================
- Plus cohérent
- Toujours prudent
- Moins bloqué que la version ultra stricte
- Cherche quelques setups propres sans spammer
...
def run_bot():
    log("=" * 60)
    log("🤖 BOT SAFE PRO — Version équilibrée")
    log("=" * 60)
